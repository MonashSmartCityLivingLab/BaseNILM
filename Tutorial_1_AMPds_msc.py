...
setupDat['batch'] = 100                                                                                              # number of samples fed at once to training
setupDat['Shuffle'] = False                                                                                             # False: no shuffling, True: shuffling data when splitting
setupDat['rT'] = 0.5                                                                                                    # training proportion (0, 1)
setupDat['rV'] = 0.5                                                                                                    # validation proportion (0, 1) as percentage from training proportion
...
setupDat['test'] = 'trainingdata'                                                                                              # name of testing datasets (one)
