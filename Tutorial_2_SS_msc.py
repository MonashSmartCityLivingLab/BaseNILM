...
# Datasets
# ------------------------------------------
setupDat['folder'] = 'msc-updated'                                                                                            # name of the folder for the dataset under \data
...
setupPar['window'] = 560                                                                                               # window length (samples)
setupPar['overlap'] = 280                                                                                                 # overlap between consecutive windows (no overlap during test if -1)
setupPar['outseq'] = 560                                                                                               # 0) seq2point, x) length of the subsequence in samples
setupPar['yFocus'] = 280                                                                                                # focus point for seq2point (average if -1)
